...
### [Behavioural Interview Coach](https://behavioral-interview-coach.vercel.app/)
*(FastAPI, Python, Computer Vision, FFmpeg)*  
A real-time interview simulator quantifying subconscious cues (eye contact, micro-expressions) to improve candidate delivery.

### [SikhAI](https://sikhai.vercel.app/)
*(Next.js, Vertex AI, RAG)*  
Context-aware spiritual companion chatbot with daily Hukamnama integration and community event organization.

### Android Development
- **Pitch Prime**: Pitch detection and vocal training app.
- **Hue Christmas**: Festive light control for Philips Hue systems.
