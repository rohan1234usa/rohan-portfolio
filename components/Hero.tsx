        ...
        <section ref={sectionRef} className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden">
            <div className="container mx-auto px-6 grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center">
                <StaggerGroup immediate delayChildren={0.1} stagger={0.09}>
                    ...
                    <StaggerItem className="mt-10 max-w-sm font-mono text-xs leading-relaxed text-brand-charcoal/75 dark:text-brand-cream/75 bg-white/70 dark:bg-brand-surface/80 border border-brand-charcoal/15 dark:border-brand-cream/15 rounded-sm shadow-md">
                        ...
                        <TypingCode
                            ...
                            segments={[
                                ...
                                { text: " focus", className: "text-brand-navy dark:text-brand-cream" },
                                { text: " = [\n  " },
                                { text: "\"Multimodal RAG\"", className: "text-brand-charcoal/90 dark:text-brand-cream/90" },
                                { text: ",\n  " },
                                { text: "\"CV pipelines @ scale\"", className: "text-brand-charcoal/90 dark:text-brand-cream/90" },
                                { text: ",\n  " },
                                { text: "\"Real-time inference\"", className: "text-brand-charcoal/90 dark:text-brand-cream/90" },
                                { text: ",\n];" },
                            ]}
                        />
                    </StaggerItem>
